...
import 'package:new_one_flutter_app/modules/news_app/web_view/web_view.dart';
...
void showToast({@required String text, @required ToastState state}) =>
    Fluttertoast.showToast(
        ...
        backgroundColor: chooseBuildColor(state: state),
        textColor: Colors.white,
        fontSize: 16.0);
enum ToastState { SUCCESS, ERROR, WARNING }
Color chooseBuildColor({@required ToastState state}) {
  Color color;
